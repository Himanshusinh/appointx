...
const GetConfermation = () => {
  return (
    <div className='bg-[#3F454F] h-[400px] w-[400px] rounded-2xl flex flex-col justify-center items-center'>  
        <h1 className='font-clash text-6xl text-[#ffffff] '>Get Confirmation</h1>
